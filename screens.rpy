...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("EndReplay") action EndReplay(confirm=True)
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("AutoSave"), quick=_("Q.Save"))
            ...
            vbox:
                ...
                if config.has_sync:
                    if CurrentScreenName() == "save":
                        textbutton _("UploadSync"):
                            action UploadSync()
                            xalign 0.5
                    else:
                        textbutton _("DownloadSync"):
                            action DownloadSync()
                            xalign 0.5
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            ...
                            if config.sample_sound:
                                textbutton _("sound") action Play("sound", config.sample_sound)
                    ...
                    if config.has_voice:
                        ...
                        hbox:
                            ...
                            if config.sample_voice:
                                textbutton _("voice") action Play("voice", config.sample_voice)
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Advances the dialogue and activates the interface.")

    hbox:
        label _("Space")
        text _("Advances the dialogue without requiring a selection.")
    ...
    hbox:
        label _("Ctrl")
        text _("Skips dialogue when held down.")

    hbox:
        label _("Tab")
        text _("Keeps dialogue skipping.")

    hbox:
        label _("Page Up")
        text _("Rewinds to previous dialogue.")

    hbox:
        label _("Page Down")
        text _("Fast-forwards to later dialogue.")
    ...
    hbox:
        label _("V")
        text _("Toggles assistive {a=https://www.renpy.org/l/voicing} Self-Vocing {/a}.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Right Shoulder Key")
        text _("Fast-forwards to later dialogue.")

    hbox:
        label _("D-Pad, Joystick")
        text _("Navigates the interface.")

    hbox:
        label _("Start, Guide, B/Right Key")
        text _("Accesses the game menu.")
    ...
    textbutton "Calibrate" action GamepadCalibrate()
